...
func (c *exchangeServiceClient) CreateExchange(ctx context.Context, in *Exchange, opts ...grpc.CallOption) (*Error, error) {
...
func (UnimplementedExchangeServiceServer) CreateExchange(context.Context, *Exchange) (*Error, error) {
...
func _ExchangeService_CreateExchange_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExchangeServiceServer).CreateExchange(ctx, req.(*Exchange))
	}
