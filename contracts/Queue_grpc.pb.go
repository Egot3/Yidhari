...
func (c *queueServiceClient) CreateQueue(ctx context.Context, in *Queue, opts ...grpc.CallOption) (*Error, error) {
...
func (c *queueServiceClient) DeleteQueue(ctx context.Context, in *Queue, opts ...grpc.CallOption) (*Error, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Error)
...
func (UnimplementedQueueServiceServer) CreateQueue(context.Context, *Queue) (*Error, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateQueue not implemented")
}
func (UnimplementedQueueServiceServer) DeleteQueue(context.Context, *Queue) (*Error, error) {
...
func _QueueService_DeleteQueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueueServiceServer).DeleteQueue(ctx, req.(*Queue))
	}
	return interceptor(ctx, in, info, handler)
}
